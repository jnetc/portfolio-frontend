...
export const stackoverflowContent = {
  reputation: {
    en: 'Reputation',
    ru: 'Репутация',
    fi: 'Maine',
...
export const anchor = {
  portfolio: {
    ...
    desc: {
      ru: 'Мои последние работы',
      en: 'My last works',
      fi: 'Viimeiset teokseni',
    },
  },
  skills: {
    link: {
...
export const separators = {
  ...
  about: {
    title: {
      ...
      fi: 'Suoritetut tai keskeneräiset verkkokurssit',
    },
    desc: {
      ru: 'и сертификаты',
